...
class StoreData:
    ...
    def store_process_events(self, filename: str) -> None:
        table: str = "systemevents(timestamp, category, processid, process, hostname, parentprocessid, parentimage, username, dnsname, dnsdate, sourceip, sourceport, destinationip, destinationport, asname, status, image, commandline, sid)"
            ...
            with open(filename, "r") as file:
                ...
                for line in lines:
                    ...
                    final_params = [
                        ...
                        data.get('process'),
                        data.get('hostname'),
                        data.get('parentprocessid') if data.get('parentprocessid') != 'N/A' else None,
                    ...
                    fillers = ("%s," * 19)[:-1]
                    sqlInsertStatement = (
                        "INSERT INTO " + table + " VALUES(" + fillers + ")"
                    )
            ...
            with open(filename, "r") as file:
                ...
                for line in lines:
                    ...
                    final_params = [
                        ...
                        "",
                        data.get("sourceip"),
                        data.get("sourceport") if data.get('sourceport') != 'N/A' else None,
                        data.get("destinationip"),
                        data.get("destinationport") if data.get('destinationport') != 'N/A' else None,
                        "",
                        data.get("status"),
                        "",
                        "",
            ...
            with open(filename, "r") as file:
                ...
                for line in lines:
                    ...
                    final_params = [
                        ...
                        "",
                        data.get("hostname"),
                        data.get("ec2_instance_id"),
                        data.get("private_ips"),
                        data.get("public_ip"),
                        "",
                        "",
                        "",
    ...
    def store_debug_events(self, filename: str) -> None:
        table = (
            "systemlog(timestamp, event, hostname, source, platform, message, value)"
        )
        with psycopg.connect(
            host=self.host,
            port=self.port,
