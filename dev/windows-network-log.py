...
class WindowsNetworkLogger():
  ...
  def log_existing(self) -> None:
    ...
    for conn in connections:
      ...
      self.log_connection("existing connection", conn)
  ...
  def monitor_events(self) -> None:
    ...
    for key in created_keys:
      self.log_connection("connection created", current_connections[key])

    for key in terminated_keys:
      self.log_connection("connection terminated", self.previous_connections[key])
